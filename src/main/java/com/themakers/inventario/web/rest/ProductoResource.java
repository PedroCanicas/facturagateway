...
import com.themakers.inventario.repository.ProductoRepository;
import com.themakers.inventario.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.themakers.inventario.domain.Producto}.
 */
@RestController
@RequestMapping("/api")
@Transactional
